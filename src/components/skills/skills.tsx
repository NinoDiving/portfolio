    ...
    <section className="">
      ...
      <div className="flex flex-col items-center justify-center p-4">
        <p className="text-xl text-gray-700 mb-4">
          ...
          about creating applications and websites that are both beautiful and
          functional, I strive to craft tailored experiences that serve both
          users and business goals. Curious and committed to continuous
          learning, I&apos;m always ready to make concrete suggestions to help
          improve a product.
        </p>
